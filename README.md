...
Updated 20 September 2026. Product screenshots use fictional demo data; Oris and Manzl are local UI demos. Dubai Game imagery is visual development, not gameplay. The earlier Frame video imagery has been removed from the current project page. Build 3.0.0 (13) completed Apple processing, has saved What to Test instructions and is assigned to Owner Testing (Internal, one tester); installation and physical-device acceptance remain unverified.


Build 13 improves local task editing, reviewed-action flow and capture capability warnings. Cloud AI is disabled in the release. Source-backed proposed actions and durable completion receipts remain available; successful generation and a real iPhone voice-to-action loop remain unverified. The next validation is a supported-device loop followed by a small seven-day voluntary-use pilot.

[Watch the latest Frame local workflow demo →](https://kbartawi.github.io/projects/frame/#demo) · 78 seconds, silent, fictional test data. Development build13 shows task editing, source review, completion receipts and an audio-only warning. It is not proof of AI generation. Build 3.0.0 (13) is now the latest verified internal TestFlight release; the video remains a development recording. [Earlier build10 demo](https://kbartawi.github.io/media/frame/actual/build10/actual-build10-demo.mp4) remains available.
