...
Frame is being developed as a voice-first personal workspace: capture a thought or conversation, review what matters, recover original context and prepare a useful next step. Build 3.0.0 (4) remains the only verified assigned internal release; signed build 3.0.0 (7) uploaded at 13:18:15 Dubai on 20 September. Build 7 improves the interface and protects unsaved edits and follow-up drafts. Its full suite executed 103 checks: 102 passed and one device-only skip. Simulator draft save/reopen and native Calendar cancel/save callbacks were verified. Build 7 Apple processing completion and group assignment remain unverified. Physical-device recording, installation and acceptance remain unverified. Optional AI uses Apple’s on-device model on compatible devices with iOS 26.4 or later. English output and supported on-device transcription only; mixed-language accuracy is unverified. Frame does not send messages automatically or record other-app calls. Earlier video-prototype work is retained separately.
